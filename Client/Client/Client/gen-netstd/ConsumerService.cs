...
public partial class ConsumerService
{
  ...
  public interface IAsync
  {
    ...
    Task<bool> AddTrackToMediaAsync(string fileName, byte[] image, CancellationToken cancellationToken = default(CancellationToken));
  ...
  public class Client : TBaseClient, IDisposable, IAsync
  {
    ...
    public async Task<bool> AddTrackToMediaAsync(string fileName, byte[] image, CancellationToken cancellationToken = default(CancellationToken))
    {
  ...
  public class AsyncProcessor : ITAsyncProcessor
  {
    ...
    public async Task AddTrackToMedia_ProcessAsync(int seqid, TProtocol iprot, TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        try
        {
          result.Success = await _iAsync.AddTrackToMediaAsync(args.FileName, args.Image, cancellationToken);
        }
        catch (SErrorSystemException sErrorSystemE)
        {
          result.SErrorSystemE = sErrorSystemE;
