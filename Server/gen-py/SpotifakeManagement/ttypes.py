...
class Interpreter(object):
    ...
    def __init__(self, idInterpreter=None, name=None,):
        self.idInterpreter = idInterpreter
        self.name = name
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I16:
                    self.idInterpreter = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('Interpreter')
        if self.idInterpreter is not None:
            oprot.writeFieldBegin('idInterpreter', TType.I16, 1)
            oprot.writeI16(self.idInterpreter)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        if self.idInterpreter is None:
            raise TProtocolException(message='Required field idInterpreter is unset!')
        return
...
all_structs.append(Interpreter)
Interpreter.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'idInterpreter', None, None, ),  # 1
...
Track.thrift_spec = (
    ...
    (7, TType.STRUCT, 'interpreter', [Interpreter, None], None, ),  # 7
