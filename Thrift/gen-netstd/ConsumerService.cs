...
public partial class ConsumerService
{
  ...
  public interface IAsync
  {
    ...
    Task<bool> UpdateConsumerPasswordAsync(string email, string newPassword, CancellationToken cancellationToken = default(CancellationToken));
  ...
  public class Client : TBaseClient, IDisposable, IAsync
  {
    ...
    public async Task<bool> UpdateConsumerPasswordAsync(string email, string newPassword, CancellationToken cancellationToken = default(CancellationToken))
    {
  ...
  public class AsyncProcessor : ITAsyncProcessor
  {
    ...
    public async Task UpdateConsumerPassword_ProcessAsync(int seqid, TProtocol iprot, TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        try
        {
          result.Success = await _iAsync.UpdateConsumerPasswordAsync(args.Email, args.NewPassword, cancellationToken);
        }
        catch (SErrorUserException sErrorUserE)
        {
          result.SErrorUserE = sErrorUserE;
