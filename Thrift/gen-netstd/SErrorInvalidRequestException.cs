...
/// </summary>
public partial class SErrorInvalidRequestException : TException, TBase
{
  ...
  public SErrorInvalidRequestException()
  {
  }
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("SErrorInvalidRequestException");
  ...
  {
    var other = that as SErrorInvalidRequestException;
  ...
  {
    var sb = new StringBuilder("SErrorInvalidRequestException(");
    bool __first = true;
    if (Message != null && __isset.message)
    {
